...
np.random.seed(10)
info = [ 
         [ "Petty-NASA",       [1]               , [0.8901960784313725, 0.10196078431372549, 0.10980392156862745],  "$^{s,i}$"  ],  \
         [ "FIO-ESM",          [1]               , [1.0, 0.49803921568627452, 0.0],  "$^d$"                ],  \
         [ "Lamont",           [1]               , [0.20000000000000001, 0.62745098039215685, 0.17254901960784313],  "$^{s,i}$"  ],  \
         [ "barreira",         [1]               , [0.65098039215686276, 0.80784313725490198, 0.8901960784313725],  "$^{s,i}$"  ],  \
         [ "Nico-Sun",         range(1, 3 + 1)   , [0.792156862745098, 0.69803921568627447, 0.83921568627450982],   "$^s$"                ],  \
