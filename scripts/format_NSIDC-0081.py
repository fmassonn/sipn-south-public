...
yearb=2022        # First year to process (will do this year and the following)
...
fileout = outdir + "siconc_SIday_NSIDC-0081_r1i1p1_" + str(yearb) + "0101-" + str(yeare) + "1231_" + hemi + ".nc"
# Create file
