...
# Read in the data
f = Dataset("../data/2018-2019/netcdf/barreira_001_concentration_monthly.nc", mode = "r")
...
areacello = R * np.cos(2.0 * np.pi / 360.0 * lat) *  2.0 * np.pi / 360.0 * 2.0  * \
            R *                                         (2.0 * np.pi / 360.0 * 0.5) 

f = Dataset("../data/2018-2019/netcdf/barreira_001_concentration.nc", mode = "w")
